...
HD_PWD='E:/sync_project/project_1/project_1.runs/syncprotect_lutrom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log syncprotect_lutrom.vds -m64 -mode batch -messageDb vivado.pb -notrace -source syncprotect_lutrom.tcl
