...
HD_PWD='E:/sync_project/project_1/project_1.runs/mult_32x32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_32x32.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mult_32x32.tcl
