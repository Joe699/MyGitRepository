...
HD_PWD='E:/sync_project/project_1/project_1.runs/walshtable_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log walshtable.vds -m64 -mode batch -messageDb vivado.pb -notrace -source walshtable.tcl
