...
HD_PWD='E:/sync_project/project_1/project_1.runs/clk_wiz_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source clk_wiz_1.tcl
