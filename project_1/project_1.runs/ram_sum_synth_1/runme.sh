...
HD_PWD='E:/sync_project/project_1/project_1.runs/ram_sum_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_sum.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ram_sum.tcl
