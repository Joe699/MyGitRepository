...
HD_PWD='E:/sync_project/project_1/project_1.runs/ram_2port_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_2port_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ram_2port_0.tcl
