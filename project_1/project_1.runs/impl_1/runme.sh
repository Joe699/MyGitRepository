...
HD_PWD='E:/sync_project/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log recv_ctrl.vdi -applog -m64 -messageDb vivado.pb -mode batch -source recv_ctrl.tcl -notrace
