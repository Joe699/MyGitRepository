...
#
# Generated by Vivado on Fri Oct 02 16:09:38 +0800 2020
...
# Script info
echo -e "clk_wiz_1.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./clk_wiz_1.sh -help\" for more information)\n"
  exit 1
fi
...
compile()
{
  ...
  ncvlog -work xil_defaultlib $opts_ver \
    "$ref_dir/../../../../project_1.srcs/sources_1/ip/clk_wiz_1/clk_wiz_1_clk_wiz.v" \
    "$ref_dir/../../../../project_1.srcs/sources_1/ip/clk_wiz_1/clk_wiz_1.v" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.clk_wiz_1 xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.clk_wiz_1 -input simulate.do
}
# Script usage
usage()
{
