...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto f5a0df1320994e459de06066fa9bc256 -m64 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot clk_wiz_1 xil_defaultlib.clk_wiz_1 xil_defaultlib.glbl -log elaborate.log
}
