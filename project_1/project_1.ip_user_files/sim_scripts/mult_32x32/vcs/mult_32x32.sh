...
# executing this script. Please type 'mult_32x32.sh -help' for more information.
#
...
reset_run()
{
  files_to_remove=(ucli.key mult_32x32_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc mult_32x32_simv.daidir)
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../project_1.srcs/sources_1/ip/mult_32x32/sim/mult_32x32.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.mult_32x32 -o mult_32x32_simv
}
...
simulate()
{
  ...
  ./mult_32x32_simv $opts -do simulate.do
}
# Script usage
usage()
{
