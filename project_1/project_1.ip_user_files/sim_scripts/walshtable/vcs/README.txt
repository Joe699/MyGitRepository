...
#
# Generated by export_simulation on Tue Oct 13 21:01:45 +0800 2020
#
################################################################################
...
switch to the './walshtable.sh' script.

./walshtable.sh -reset_run
...
./walshtable.sh -noclean_files

For more information on the script, please type './walshtable.sh -help'.
